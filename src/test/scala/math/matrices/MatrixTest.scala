...
trait MatrixTest extends FunSuite{
	test("Number Matrix"){
		...
		assert(matrix1 - 1 equals  matrix2,"scala operation")
		assert(matrix1 - matrix2 equals  new NumberMatrix(2,3,Array[Double](1,1,1,1,1,1)),"matrix to matrix operation")
		...
		assert(matrix1 * matrix3 equals  new NumberMatrix(2,2,Array[Double](16.0, 22.0, 34.0, 49.0)),"operable matrix multiplication")
	}
	test("Square Matrix"){
		...
		assert(matrix1 * matrix3 equals new SquareMatrix(3,Array[Double](24.0, 30.0, 36.0, 51.0, 66.0, 81.0, 78.0, 102.0, 126.0)),"matrix matrix multiplication" )
		...
		assert(matrix4.inverse equals  new SquareMatrix(3,
		...
		assert(matrix4.cofactor(1,2) equals new SquareMatrix(2,Array(2,3,17,19)),"matrix cofact with available index")
		assert(matrix4.cojoint equals new SquareMatrix(3,Array(6,60,-54,26,-39,13,-16,9,1)))
	}
